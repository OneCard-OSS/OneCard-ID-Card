/*
* Copyright 2025 Jay Kang (255@0xff.kr)

This project includes the following software licensed under the Apache License, Version 2.0:

  * This component (ECP256.java)
    Copyright 2020 darconeous (https://github.com/darconeous/gauss-key-card/blob/master/src/io/github/darconeous/gausskeycard/ECP256.java)
...
/*
 * 파일명: ECP256.java
 * 설명: ECDSA의 파라미터로 NIST P-256(secp256r1) curve를 사용하기 위한 클래스입니다.
 *      OneCardApplet.java에서 이 파일을 참조합니다.
 */
